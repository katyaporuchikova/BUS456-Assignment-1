...
Table 5 demonstrates that different groups have different means. The acceptance rate is the highest for private financed group. However,others are not significant. that is to say privatefinanced is important variable in treatment group. So we can find if somebody they try to  individually pay for the insurance out of their own pocket probably means it’s more different
than paid via employer/union/credit card. 
